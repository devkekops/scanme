module github.com/devkekops/scanme

go 1.18

require github.com/projectdiscovery/subfinder/v2 v2.5.2
...
require (
	...
	github.com/projectdiscovery/rawhttp v0.0.8-0.20220526170355-03de6bb78f37 // indirect
